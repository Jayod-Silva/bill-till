...
import { Zap, Shield, BarChart3, Cloud, CreditCard, Smartphone } from 'lucide-react';

const propositions = [
  {
    icon: BarChart3,
    title: 'Access Anywhere',
    description: 'Check your POS system anytime, anywhere with any device. Complete mobility and flexibility for modern business management.',
    color: 'text-primary',
  ...
  },
  {
    ...
    description: 'Process transactions in milliseconds. No lag, no waiting, just seamless checkout experiences.',
    color: 'text-warning',
  ...
  },
  {
    ...
    description: 'End-to-end encryption, PCI DSS compliance, and fraud protection built into every transaction.',
    color: 'text-success',
