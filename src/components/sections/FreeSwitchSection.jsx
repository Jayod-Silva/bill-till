    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6 mb-16 max-w-5xl mx-auto px-4">
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Zero Setup Fees</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
              No charges for initial setup and configuration of your new POS system
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Free Data Migration</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">No Switching Charges</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Free Training</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
